...
<style type="text/css">
 .enroll{
 background-image: url("images/addStudents.jpg");
...
<img src="images/Cjclogo.jpg" width="100px" height="60px">
<div class="pt-2">
<a href="#enroll">
...
<section class="vh-100 gradient-custom enroll mt-2" id="enroll">
 ...
 <div class="card shadow-2-strong card-registration mt-0" style="border-radius: 15px;border: 5px solid blue;">
...
name="studentAge"/>
 ...
 <label clclass="form-label" for="phoneNumber">Student Collage Name</label>
 </div>
 </div>
 </div>
 <div class="row">
...
<label class="form-label select-label">Batch Number</label>
 ...
 <section class="view" style="height:530px;border:5px solid blue;"  id="view">
 <h1 style="color:blue;" class="text-center " >Student Details..!</h1>
...
name="batchNumber">
 ...
 <td>
 <div class="btn-group btn-group-sm" role="group" arialabel="...">
